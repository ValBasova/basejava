                        ...
                        <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                            <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizationList()%>"
                                ...
                                <dl>
                                    ...
                                    <dd><input type="text" name='${type}${counter.index}url' size=100
                                               value="${org.url}"></dd>
                                    </dd>
                                </dl>
                                <br>
                                <div style="margin-left: 30px">
                                    <c:forEach var="pos" items="${org.positions}" varStatus="posCounter">
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <input type="text"
                                                       name="${type}${counter.index}startDate${posCounter.index}"
                                                       size=10
                                                       value="<%=DateUtil.format(pos.getTimeStart())%>"
                                                       placeholder="yyyy-MM">
                                            </dd>
                                        </dl>
                                        <dl>
                                            ...
                                            <dd>
                                                <input type="text"
                                                       name="${type}${counter.index}endDate${posCounter.index}" size=10
                                                       value="<%=DateUtil.format(pos.getTimeEnd())%>"
                                                       placeholder="yyyy-MM">
                                        </dl>
                                        <dl>
                                            <dt>Должность:</dt>
                                            <dd><input type="text"
                                                       name='${type}${counter.index}title${posCounter.index}' size=75
                                                       value="${pos.title}">
                                        </dl>
                                        <dl>
                                            <dt>Описание:</dt>
